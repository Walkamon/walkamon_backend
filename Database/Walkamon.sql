...
IF NOT EXISTS (SELECT 1 FROM system_settings WHERE setting_key = 'StepToExpRate')
    INSERT INTO system_settings (setting_key, setting_value) VALUES ('StepToExpRate', '5');
IF NOT EXISTS (SELECT 1 FROM system_settings WHERE setting_key = 'PetExpIncreasePerLevel')
    INSERT INTO system_settings (setting_key, setting_value) VALUES ('PetExpIncreasePerLevel', '50');
IF NOT EXISTS (SELECT 1 FROM system_settings WHERE setting_key = 'EnergyRecoveryIntervalMinutes')
    INSERT INTO system_settings (setting_key, setting_value) VALUES ('EnergyRecoveryIntervalMinutes', '3');
IF NOT EXISTS (SELECT 1 FROM system_settings WHERE setting_key = 'BondDecayPercentPerDay')
    INSERT INTO system_settings (setting_key, setting_value) VALUES ('BondDecayPercentPerDay', '5');
IF NOT EXISTS (SELECT 1 FROM system_settings WHERE setting_key = 'LifeForceDecayPercentPerDay')
    INSERT INTO system_settings (setting_key, setting_value) VALUES ('LifeForceDecayPercentPerDay', '5');
IF NOT EXISTS (SELECT 1 FROM system_settings WHERE setting_key = 'PassiveStatFloorPercent')
    INSERT INTO system_settings (setting_key, setting_value) VALUES ('PassiveStatFloorPercent', '30');
GO
...
IF NOT EXISTS (
    SELECT 1
    FROM users
    WHERE normalized_email = 'ADMIN@WALKAMON.COM'
...
BEGIN
    ...
    VALUES (
        @AdminUserId,
        @AdminRoleId,
        N'admin@walkamon.com',
        N'ADMIN@WALKAMON.COM',
        N'$2a$11$wRaS5Vkn8xNShL56gB3Wa.ERjVMdwmYe1Y3/Wsp8MOhuBH3.XExqa',
        1,
        'active',
        0,
        SYSUTCDATETIME(),
    ...
    VALUES (
        @AdminUserId,
        N'admin',
        N'Walkamon system administrator',
        'vi-VN',
        'system',
        N'Asia/Ho_Chi_Minh',
        0,
